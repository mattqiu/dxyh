                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="form-submit" role="form" style="padding-top: 10px;" action="<?php echo ($Url); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-xs-10 col-sm-5" name="linkName" value="<?php echo ($rows["link_name"]); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="url" id="form-field-3" class="col-xs-10 col-sm-5" name="link" value="<?php echo ($rows["link"]); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="fileupload"> logo图片 </label>
