        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo U('System/website_image');?>">系统设置</a>
                    </li>
                    <li>
                        <a href="<?php echo U('System/website_image');?>">网站图片</a>
                    </li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="form-submit" role="form" style="padding-top: 10px;" action="<?php echo ($Url); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="imageType" class="col-sm-5" id="form-field-1">
                                        <option value="0">请选择</option>
                                        <option value="1" <?php echo (Judgement($rows["type"],1,"selected")); ?>>首页轮播</option>
                                        <option value="2" <?php echo (Judgement($rows["type"],2,"selected")); ?>>家庭护理</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="fileupload"> pc端图片 </label>
                                <div class="col-sm-9"><!--/upload/images/1230445787101_mthumb.jpg-->
                                    ...
                                    <div class="showImage" style="width:520px;">
                                        <img src="<?php echo ($rows["image"]); ?>" style="width: 523px;height: 200px;background-color: darkgrey;" />
                                        <p class="message_p1" style="position: absolute;top: 70px;left: 28px;font-size: xx-large;font-family: cursive;color: aliceblue;">点击此处上传图片,尺寸:1200x460</p>
                                    </div>
                                    <br>
                            ...
                            <div class="form-group image2">
                                <label class="col-sm-3 control-label no-padding-right" for="fileupload"> 移动端图片 </label>
                                <div class="col-sm-9"><!--/upload/images/1230445787101_mthumb.jpg-->
                                    <input type="file" id="fileupload2" onchange="showPreview2(this)" class="col-xs-10 col-sm-5" name="fileImage2" style="display: none;" />
                                    <div class="showImage2" style="width:270px;">
                                        <img src="<?php echo ($rows["app_image"]); ?>" style="width: 270px;height: 200px;background-color: darkgrey;" />
                                        <p style="position: absolute;top: 70px;left: 50px;font-size: x-large;font-family: cursive;color: aliceblue;">点击此处上传图片<br>&nbsp;&nbsp;尺寸:640x320</p>
                                    </div>
                                    <br>
                                    <button type="button" class="unImage2" onclick="unsetImage2()" style="display: none;">清除上传图片</button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> 链接 </label>
                                <div class="col-sm-9">
                                    <input type="url" id="form-field-3" class="col-xs-10 col-sm-5" name="imgLink" value="<?php echo ($rows["img_link"]); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="radio" class="" name="status" value="1" <?php echo (Judgement($rows["status"],1,"checked=checked")); ?> />&nbsp;是
                                    <input type="radio" class="" name="status" value="0" <?php echo (Judgement($title,"新增图片","checked")); ?> <?php echo (Judgement($rows["status"],0,"checked")); ?>/>&nbsp;否
                                </div>
                            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        var image1 = "<?php echo ($rows["image"]); ?>";
        var image2 = "<?php echo ($rows["app_image"]); ?>";
        if (image1 == ""){
            $(".showImage p").css('display','block');
        }else{
            $(".showImage p").css('display','none');
        }
        if (image2 == ""){
            $(".showImage2 p").css('display','block');
        }else{
            $(".showImage2 p").css('display','none');
        }
        var imageType = "<?php echo ($rows["type"]); ?>";
        if (imageType == 2){
    ...
    function showPreview2(source) {
        ...
        $(".showImage2 p").css('display','none');
        $(".unImage2").css('display','block');
    };

    function unsetImage2() {
        $(".showImage2 img").attr("src", "");
        $(".showImage2 p").css('display','block');
        var obj = document.getElementById('fileupload') ;
        obj.outerHTML = obj.outerHTML;
        $(".unImage2").css('display','none');
    }

    $("select[name='imageType']").change(function () {
        var item = $("select[name='imageType']").val();
        if (item == 2){
            $(".image2").css("display","none");
            $(".message_p1").html("点击此处上传图片,尺寸:208x294");
        }else {
            $(".image2").css("display","block");
            $(".message_p1").html("点击此处上传图片,尺寸:1200x460");
            $(".showImage2 p").css('display','block');
        }
    });
