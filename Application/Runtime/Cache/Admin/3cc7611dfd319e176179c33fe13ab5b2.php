        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo U('Public/modify_password');?>">系统设置</a>
                    </li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" style="padding-top: 10rem;" action="<?php echo U('System/account_add');?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="form-field-1" class="col-xs-10 col-sm-5" name="originalPasswd" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="form-field-2" class="col-xs-10 col-sm-5" name="newPasswd" />
                                </div>
                            </div>
