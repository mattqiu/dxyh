                    ...
                    <div class="col-xs-12">
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover center">
                            ...
                            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <?php if(!empty($vo["image"])): ?><img src="<?php echo ($vo["image"]); ?>" style="width: 60px;height: 60px;" /><?php endif; ?>
                                    </td>
                                    <td><?php echo ($vo["img_link"]); ?></td>
                                    <td class="hidden-480"><?php echo ($vo["status"]); ?></td>
                                    <td class="center">
                                        <a class="btn btn-xs btn-info ajax-get" title="编辑" href="<?php echo U('System/website_edit',array('id'=>$vo['id']));?>">
