								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form id="form-login" action="<?php echo U('Public/login');?>" method="post">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="button" class="width-35 pull-right btn btn-sm btn-primary ajax-post" target-form="form-login" >
															<i class="icon-key"></i>
															登录
														</button>
													</div>
