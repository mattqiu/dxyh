        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="page-header">
                    <?php if($whetherAudit == 1): ?><span>关键字</span>
                    <input type="text" name="keyword" form="form1" value="<?php echo ($keyword); ?>" placeholder="请输入手机/昵称/姓名" />
                    <span>审核状态</span>
                    <select name="status" form="form1">
                        <option value="0">请选择</option>
                        <option value="3" <?php echo (Judgement($status,3,"selected")); ?>>未审核</option>
                        <option value="1" <?php echo (Judgement($status,1,"selected")); ?>>已通过</option>
                        <option value="2" <?php echo (Judgement($status,2,"selected")); ?>>未通过</option>
                    </select>

                    <input type="submit" name="" value="搜索" form="form1">
                    <a href="<?php echo U('Activity/signExport', array('id'=>$id));?>" class="ajax-get"><button>导出</button></a>
                    <button class="audit" value="1">审核通过</button>
                    <button class="audit" value="2">审核不通过</button>
                    <form action="" method="get" id="form1"></form><?php endif; ?>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover center">
                            ...
                            <tr>
                                ...
                                <?php if($whetherAudit == 1): ?><th class="center">处理状态</th><?php endif; ?>
                            </tr>
                            </thead>
                            ...
                            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="hidden-480"><?php echo ($vo["sign_time"]); ?></td>
                                    <?php if($whetherAudit == 1): ?><td>
                                            <?php echo ($vo["audit"]); ?>
                                        </td><?php endif; ?>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.audit').click(function(){
            ...
            var whetherAudit = "<?php echo ($_GET['whetherAudit']); ?>";
            $.ajax({
                url: "<?php echo U('Activity/signAudit');?>",
                type: 'POST',
