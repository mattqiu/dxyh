                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="form-submit" role="form" style="padding-top: 10rem;" action="<?php echo ($Url); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" class="col-xs-10 col-sm-5" name="sort" value="<?php echo ($rows["sort"]); ?>" placeholder="请输入章节名称，格式：第一章或第一节" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-xs-10 col-sm-5" name="sort" value="<?php echo ($rows["sort"]); ?>" placeholder="请输入章节标题，格式：基本家庭护理操作" />
                                </div>
                            </div>
