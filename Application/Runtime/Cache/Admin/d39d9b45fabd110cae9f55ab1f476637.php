        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="page-header">
                    <a href="<?php echo U('System/link_add');?>" class="btn btn-xs btn-info">添加</a>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover center">
                            ...
                            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="hidden-480"><?php echo ($vo["link"]); ?></td>
                                    <td class="center">
                                        <a class="btn btn-xs btn-info ajax-get" title="编辑" href="<?php echo U('System/link_edit',array('id'=>$vo['id']));?>">
                                            <i class="icon-edit bigger-120"></i>
                                        </a>

                                        <a class="btn btn-xs btn-danger ajax-get confirm" title="删除" href="<?php echo U('System/link_del',array('id'=>$vo['id']));?>">
